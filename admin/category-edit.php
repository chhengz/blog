                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea name="meta_description" id="meta_description" placeholder="Enter Meta Description" rows="4"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea name="meta_keyword" id="meta_keyword" rows="4" placeholder="Enter Meta Keyword"
